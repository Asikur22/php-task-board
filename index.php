...
<head>
  ...
  <link rel="stylesheet" href="assets/style.css?v=1.10.70">
...
<body>
        ...
        <div class="profile-layout">
          ...
          <div class="profile-panels">
            ...
            <section id="profile-panel-projects" class="profile-panel" role="tabpanel" data-profile-panel="projects" hidden>
              ...
              <p class="modal-hint">Archived projects you own can be restored or permanently deleted. Active projects must be archived first.</p>
  ...
  <div id="app-version" class="app-version" title="Task Board Version">v1.10.70</div>
  ...
  <script src="assets/app.js?v=1.10.70"></script>
  <script src="assets/ai-chat.js?v=1.10.70"></script>
</body>
</html>
